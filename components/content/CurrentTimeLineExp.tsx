    ...
    <Timeline>
      ...
      <TimelineEvent active>
        ...
        <TimelineEvent.Description>
          Analista de desenvolvimento de sistemas ( Javascript, React, React Native, NextJS, CSS) - BACKEND ( NodeJS, C#)
        </TimelineEvent.Description>
      </TimelineEvent>
      ...
      <TimelineEvent>
        <TimelineEvent.Title>Município de Quirinópolis - GO</TimelineEvent.Title>
        <TimelineEvent.Description>
      ...
      <TimelineEvent>
        <TimelineEvent.Title>Comint Informática EIRELI | 16 de maio de 2008 - 27 de outubro de 2008</TimelineEvent.Title>
        <TimelineEvent.Description>
          Supervisor administrativo
        </TimelineEvent.Description>
      </TimelineEvent>
